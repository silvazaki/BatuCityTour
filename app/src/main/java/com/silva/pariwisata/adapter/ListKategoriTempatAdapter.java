...
public class ListKategoriTempatAdapter extends RecyclerView.Adapter<ListKategoriTempatAdapter.MyViewHolder> {
    ...
    public ListKategoriTempatAdapter(Context context, List<Semua> kategoriList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_detail_kategori, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.txtAlamat.setText(semua.getAlamat());
...
//        return String.format(Locale.getDefault(), "%.0f km", distance / 1000);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        protected TextView txtNama, txtJarak, txtAlamat;
        ...
        public MyViewHolder(View itemView) {
            ...
            txtJarak = itemView.findViewById(R.id.dist);
            txtAlamat = itemView.findViewById(R.id.count);
        }
    }
}
