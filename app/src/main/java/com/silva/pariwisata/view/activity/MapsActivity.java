...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        final double latitude = Double.parseDouble(prefManager.getPrefSring("latitude"));
        final double longitude = Double.parseDouble(prefManager.getPrefSring("longitude"));
        ...
        mMap.addMarker(new MarkerOptions().position(sydney).title("Posisi Kita"));
